...
mpirun --mca btl_openib_want_cuda_gdr 1 --mca pml ucx -x UCX_TLS=rc,sm,cuda_copy,gdr_copy -x LD_PRELOAD="$SANITIZER_PATH:$HOME/libuctrack.so" -np 2 ./frida_sep_run.sh

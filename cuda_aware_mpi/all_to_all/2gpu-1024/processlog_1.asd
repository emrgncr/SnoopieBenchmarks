...
API call to memcpy: , direction: HOST_TO_DEVICE, dstAddress: 0x14acd9200000, dstPitch: 4096, isAsync: 0, size: 4096, srcAddress: 0x4f842c0, srcPitch: 4096, width: 4096
CALLBACK: domain: 6
 DRIVER API call to cuMemcpyDtoH_v2 (entered)
API call to memcpy: , direction: DEVICE_TO_HOST, dstAddress: 0x4f842c0, dstPitch: 4096, isAsync: 0, size: 4096, srcAddress: 0x14acd9200000, srcPitch: 4096, width: 4096
CALLBACK: domain: 6
[pid:3428087]CUDA FIRST INT: -1277586576
BEGIN ITER 0x14acd9200000 0x14acd9201000
Create request no 0
Create request no 1
ISEND to 0 0x14acd9200000 
...
Set pointer attribute ptr:0x14acd9200000 attrib: 6
...
devPtr: 0x14acd9200000 handle: ¿¿1
 DRIVER API call to cuMemGetAddressRange_v2 (entered)
 DRIVER API call to cuDeviceGetUuid (entered)
IRECV from 0 0x14acd9201000 
 DRIVER API call to cuPointerGetAttributes (entered)
 DRIVER API call to cuDeviceGetAttribute (entered)
 DRIVER API call to cuDeviceGetAttribute (entered)
 DRIVER API call to cuDeviceGetAttribute (entered)
 DRIVER API call to cuMemGetAddressRange_v2 (entered)
 DRIVER API call to cuPointerSetAttribute (entered)
Set pointer attribute ptr:0x14acd9201000 attrib: 6
...
CALLBACK: domain: 3
handle: 0E6 devPtr 0x14acd9400000
 DRIVER API call to cuPointerGetAttributes (entered)
Error: 0
Device: 1
Memory Type: 2
...
API call to memcpy: , direction: DEVICE_TO_DEVICE, dstAddress: 0x14acd9201000, dstPitch: 4096, isAsync: 1, size: 4096, srcAddress: 0x14acd9400000, srcPitch: 4096, width: 4096src_type: 2 src_device: 1dst_type: 2 dst_device: 1
CALLBACK: domain: 6
...
DONE ITER
 DRIVER API call to cuMemcpyDtoH_v2 (entered)
API call to memcpy: , direction: DEVICE_TO_HOST, dstAddress: 0x5009030, dstPitch: 4096, isAsync: 0, size: 4096, srcAddress: 0x14acd9201000, srcPitch: 4096, width: 4096
CALLBACK: domain: 6
[pid:3428087]CUDA RECV INT: -207448509 FROM 0
 DRIVER API call to cuMemGetAddressRange_v2 (entered)

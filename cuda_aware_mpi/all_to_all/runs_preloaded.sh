...
mpirun --hostfile hostfile --map-by node --mca btl_openib_want_cuda_gdr 1 --mca pml ucx -x UCX_TLS=rc,sm,cuda_copy,gdr_copy -x LD_PRELOAD="$SANITIZER_PATH:/home/it4i-gencere/repos/SnoopieBenchmarks/cuda_aware_mpi/all_to_all/libuct_rkey_unpack.so" -np 2 ./frida_sep_run.sh

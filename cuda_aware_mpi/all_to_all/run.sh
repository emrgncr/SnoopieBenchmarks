...
PSM2_GPUDIRECT=1 mpirun --mca pml ucx --mca btl_openib_want_cuda_gdr 1 -x UCX_TLS=rc,sm,cuda_copy,gdr_copy -x PSM2_GPUDIRECT=1 -x LD_PRELOAD="$SANITIZER_PATH" -np 16 ./all_to_all -n 16 -i 1 -d 10240 > iter1out.asd

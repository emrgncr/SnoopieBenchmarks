...
PSM2_GPUDIRECT=1 mpirun --hostfile hostfile --mca pml ucx --mca btl_smcuda_use_cuda_ipc 1 -x UCX_TLS=rc,sm,cuda_copy,cuda_ipc -x PSM2_GPUDIRECT=1 -x LD_PRELOAD="$SANITIZER_PATH" -np 16 ./all_to_all -n 16 -i 1 -d 10240 > iter1out.asd

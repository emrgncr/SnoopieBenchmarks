...
LIBS :=  -L$(CUDA_LIB) -L$(CUDA_LIB)64 -L$(shell echo $$MPI_HOME)/lib #-L$(shell echo $$HOME)/repos/ucx-build/lib/ucx/ -L$(shell echo $$HOME)/repos/ucx-build/lib/ -L$(shell echo $$HOME)/repos/ucx-snoop-v2/
...
LD := -lnuma -lcuda -lcudart -lmpi #-Xlinker --no-as-needed
